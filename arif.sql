...
ALTER TABLE
    `fleets` CHANGE `layout` `layout` INT NOT NULL;

ALTER TABLE
    `fleets` DROP COLUMN `last_seat`;

-- For free_luggage_pcs
ALTER TABLE
    trips
ADD
    COLUMN free_luggage_pcs INT(11) UNSIGNED NULL;

-- For free_luggage_kg
ALTER TABLE
    trips
ADD
    COLUMN free_luggage_kg DECIMAL(10, 2) NULL;

-- For paid_max_luggage_pcs
ALTER TABLE
    trips
ADD
    COLUMN paid_max_luggage_pcs INT(11) UNSIGNED NULL;

-- For paid_max_luggage_kg
ALTER TABLE
    trips
ADD
    COLUMN paid_max_luggage_kg DECIMAL(10, 2) NULL;

-- For price_pcs
ALTER TABLE
    trips
ADD
    COLUMN price_pcs DECIMAL(10, 2) NULL;

-- For price_kg
ALTER TABLE
    trips
ADD
    COLUMN price_kg DECIMAL(10, 2) NULL;
...
ALTER TABLE
    `tickets` CHANGE `price` `price` DECIMAL(10, 2) NOT NULL,
...
ALTER TABLE
    `websettings`
ADD
    COLUMN `luggage_service` INT(11) NOT NULL
AFTER
    `pay_later`;
...
Alter TABLE
    `websettings`
ADD
    COLUMN `chat_tawk` INT(11) NOT NULL
AFTER
    `luggage_service`;

ALTER TABLE
    `fleets` DROP COLUMN `luggage_service`;

ALTER TABLE
    `users`
ADD
    COLUMN `employee_id` INT UNSIGNED
AFTER
    `id`;
...
ALTER TABLE
    stuffassigns
ADD
    COLUMN start_date DATE DEFAULT NULL
AFTER
    employee_type;
...
ALTER TABLE
    stuffassigns
ADD
    COLUMN end_date DATE DEFAULT NULL
AFTER
    start_date;
...
ALTER TABLE
    stuffassigns
ADD
    COLUMN approved_by BIGINT DEFAULT 0 NULL
AFTER
    end_date;
...
ALTER TABLE
    stuffassigns
ADD
    COLUMN is_approved INT DEFAULT 0 NULL
AFTER
    end_date;
...
VALUES
    ('1', '1', '135', 'driver_dashboard', '1');

ALTER TABLE
    `tickets`
ADD
    COLUMN `special_luggage` TEXT NULL
AFTER
    `price_kg`;
...
ALTER TABLE
    `fitnesses`
ADD
    COLUMN `subtrip_id` BIGINT NULL
AFTER
    `overall_car_condition`;
