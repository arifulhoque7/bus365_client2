                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo date('Y-m-d', strtotime($value->startdate)); ?></td>
                            <td>
                                <a onclick="assignDirver(<?php echo $value->tripid ?>)" class="btn btn-primary btn-sm"><?php echo lang("Localize.assign") ?> <?php echo lang("Localize.to") ?> <?php echo lang("Localize.driver") ?></a>
                                <a href="<?= base_url(route_to('show-driver-trip', $value->tripid)) ?>" class="btn btn-success btn-sm"><?php echo lang("Localize.approved") ?> <?php echo lang("Localize.list") ?></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
