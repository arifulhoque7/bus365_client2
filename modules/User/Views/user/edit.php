                        ...
                        <form action="<?php echo base_url(route_to('changeprofileinfo-user', $user_detail->id)) ?>" id="taxedit" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mt-3 ">
                                ...
                                <select name="id_type" class="form-control" id="id_type" aria-label="Passport/Nid" required>
                                    ...
                                    <option value="Passport" <?php echo (old('id_type') || $user_detail->id_type == 'Passport') ? 'selected' : '' ?>><?php echo lang("Localize.Passport") ?></option>
                                    <option value="Nid" <?php echo (old('id_type') || $user_detail->id_type == 'Nid') ? 'selected' : '' ?>><?php echo lang("Localize.Nid") ?></option>
                                </select>
                            </div>
