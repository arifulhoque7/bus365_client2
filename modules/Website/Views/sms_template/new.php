...
<?php echo $this->section('content') ?>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="<?php echo base_url(route_to('create-sms_template')) ?>" id="sms_templatecreate" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
