                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 mt-3 ">
                            ...
                            <select name="id_type" class="form-control" id="id_type" aria-label="Passport/Nid" required>
                                ...
                                <option value="Passport" <?php echo (old('id_type') ||  $passanger->id_type == 'Passport') ? 'selected' : '' ?>><?php echo lang("Localize.passport") ?></option>
                                <option value="Nid" <?php echo (old('id_type') ||  $passanger->id_type == 'Nid') ? 'selected' : '' ?>><?php echo lang("Localize.nid") ?></option>
                            </select>
                        </div>

                        <div class="col-md-6 col-lg-3 mt-3 ">
                            <label for="id_number"><?php echo lang("Localize.nid_passport_number") ?><abbr title="Required field">*</abbr></label>
                            <input type="text" name="id_number" class="form-control" value="<?php echo old('id_number') ?? $passanger->id_number ?>" placeholder="<?php echo lang("Localize.nid_passport_number") ?>" aria-label="Nid/Passport Number" required>
                        </div>
