                             ...
                             <td>
                                 ...
                                 <?php if ($value->tagCount == 0 && $websetting->luggage_service == 1) :
                                    ?>
                                     ...
                                     <a class="btn btn-sm btn-info text-white" data-id="<?php echo $value->id; ?>" onclick="clicked(this)"><i class="fas fa-tag"></i> <?php echo lang("Localize.generate") ?> <?php echo lang("Localize.tag") ?> </a>
                                 <?php elseif($value->tagCount > 0 && $websetting->luggage_service == 1) : ?>
                                     <a href="<?php echo  base_url(route_to('show-tag', $value->id)) ?>" class="btn btn-sm btn-success text-white"><i class="fas fa-tag"></i> <?php echo lang("Localize.show") ?> <?php echo lang("Localize.tag") ?> </a>
                                 <?php endif ?>
                             </td>
                         </tr>
 ...
 <script src="<?php echo base_url('public/js/ticket.js'); ?>"></script>
 <?php echo $this->endSection() ?>