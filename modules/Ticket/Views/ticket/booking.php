...
<div class="card mb-4">
    <div class="card-body">
        <form action="<?php echo $isrountripPost ? base_url(route_to('roundcreate-ticket')) : base_url(route_to('create-ticket')) ?>" method="post" id="createbooking" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <input type="hidden" name="free_luggage_pcs" id="free_luggage_pcs" value="<?php echo $free_luggage_pcs; ?>">
            ...
            <input type="hidden" name="paid_max_luggage_kg" id="paid_max_luggage_kg" value="<?php echo $paid_max_luggage_kg; ?>">
