                    ...
                    <table class="table table-bordered" id="">
                        ...
                        <tbody>
                            ...
                            <?php if ($websetting && $websetting->luggage_service == 1) : ?>
                                ...
                                <tr>
                                    <td colspan="4" class="text-end">
                                        <?php echo lang("Localize.total") ?> <?php echo lang("Localize.luggage") ?> <?php echo lang("Localize.fee") ?> (<?php echo  $ticket->paid_max_luggage_kg ?> Kg)
                                    </td>
                                    <td class="text-end">
                                        <?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo  $ticket->paid_max_luggage_kg * $ticket->price_kg; ?>
                                    </td>
                            ...
                            <?php if ((!empty($ticket->roundtrip_discount)) && ($ticket->roundtrip_discount > 0)) : ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <?php else : ?>
                                            <?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo  round($ticket->price, 2) - $ticket->discount - $ticket->roundtrip_discount; ?>
                                        <?php endif ?>
                                    </td>
