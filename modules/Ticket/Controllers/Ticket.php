...
class Ticket extends BaseController
{
    ...
    public function booking()
    {
        ...
        if (!empty($data['returndate'])) {
            ...
            $singleTripData['free_luggage_pcs'] = $this->request->getVar('free_luggage_pcs');
            ...
            $singleTripData['paid_max_luggage_kg'] = $this->request->getVar('paid_max_luggage_kg');
            ...
            $data['free_luggage_pcs'] = $this->request->getVar('free_luggage_pcs');
            ...
            $data['paid_max_luggage_kg'] = $this->request->getVar('paid_max_luggage_kg');
    ...
    public function roundcreate()
    {
        ...
        $ticketbooking = array(
            ...
            "free_luggage_pcs" => $this->session->get('free_luggage_pcs'),
            "free_luggage_kg" => $this->session->get('free_luggage_kg'),
            "paid_max_luggage_pcs" => $this->session->get('paid_max_luggage_pcs'),
            "paid_max_luggage_kg" => $this->session->get('paid_max_luggage_kg'),
    ...
    public function generateTag()
    {
        ...
        $free_luggage_pcs = $ticketInfo->free_luggage_pcs ?  (int)$ticketInfo->free_luggage_pcs : 0;
        $paid_max_luggage_pcs = $ticketInfo->paid_max_luggage_pcs ?  (int)$ticketInfo->paid_max_luggage_pcs : 0;
        $totalTagCount = $free_luggage_pcs + $paid_max_luggage_pcs;
