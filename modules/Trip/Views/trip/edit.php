            ...
            <div class="bg-light p-3 my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="free_luggage_pcs" name="free_luggage_pcs" value="<?php echo esc(old('free_luggage_pcs')) ?? $trip->free_luggage_pcs ?>" class="form-control" placeholder="<?php echo lang("Localize.free") ?> <?php echo lang("Localize.luggage") ?> (in pcs)">
                    </div>
                    <div class="col-md-6">
                        <label for="free_luggage_kg" class="form-label"><?php echo lang("Localize.free") ?> <?php echo lang("Localize.luggage") ?> (in kg)</label>
                        <input type="number" id="free_luggage_kg" step="0.01" name="free_luggage_kg" value="<?php echo esc(old('free_luggage_kg')) ?? $trip->free_luggage_kg ?>" class="form-control" placeholder="<?php echo lang("Localize.free") ?> <?php echo lang("Localize.luggage") ?> (in kg)">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="paid_max_luggage_pcs" name="paid_max_luggage_pcs" value="<?php echo esc(old('paid_max_luggage_pcs')) ?? $trip->paid_max_luggage_pcs  ?>" class="form-control" placeholder="<?php echo lang("Localize.paid") ?> <?php echo lang("Localize.max") ?> <?php echo lang("Localize.luggage") ?> (in pcs)">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" id="paid_max_luggage_kg" step="0.01" name="paid_max_luggage_kg" value="<?php echo esc(old('paid_max_luggage_kg')) ?? $trip->paid_max_luggage_kg  ?>" class="form-control" placeholder="<?php echo lang("Localize.paid") ?> <?php echo lang("Localize.max") ?> <?php echo lang("Localize.luggage") ?> (in kg)">
                    </div>

                    <div class="col-md-6">
                        <label for="price_pcs" class="form-label"> <?php echo lang("Localize.price") ?> (per pcs)</label>
                        <input type="number" step="0.01" id="price_pcs" name="price_pcs" value="<?php echo esc(old('price_pcs')) ?? $trip->price_pcs  ?>" class="form-control" placeholder="<?php echo lang("Localize.price") ?> (per pcs)">
                    </div>
                    <div class="col-md-6">
                        <label for="price_kg" class="form-label"><?php echo lang("Localize.price") ?> (per kg)</label>
                        <input type="number" step="0.01" id="price_kg" name="price_kg" value="<?php echo esc(old('price_kg')) ?? $trip->price_kg ?>" class="form-control" placeholder="<?php echo lang("Localize.price") ?> (per kg)">
                    </div>
                </div>
            </div>
            <?php endif ?>
